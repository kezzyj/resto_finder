...
# Creating a session to connect and access the restaurantmenuwithusers.db database
...
# to "__main__" where all the other imported Python files get the "__name__"
...
if __name__ == '__main__':
    # Flask uses secret_key to create message-flashing-sessions for users
    # For development purposes, I've setup the password to 'super_secret_key'
